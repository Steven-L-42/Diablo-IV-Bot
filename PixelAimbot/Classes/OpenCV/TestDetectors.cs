...
{
    internal class TestDetectors
    {
        private readonly Image<Bgr, byte> _enemyTemplate;
        private readonly Image<Bgr, byte> _enemyMask;
        ...
        public TestDetectors(Image<Bgr, byte> enemyTemplate, Image<Bgr, byte> enemyMask, float threshold, int rectangleX, int rectangleY, int rectangleWidth, int rectangleHeight, Point? myPosition = null, TemplateMatchingType method = TemplateMatchingType.SqdiffNormed)
        {
        ...
        private bool DetectEnemy(Image<Bgr, byte> screenCapture, bool rescaleImage = true)
        {
        ...
        public Point ClickIfFound(Image<Bgr, byte> screenCapture, bool showDetections = false, bool rescaleImage = true)
        {
