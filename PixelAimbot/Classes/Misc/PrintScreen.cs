...
public class PrintScreen
{
    ...
    public Image<Bgr, Byte> CaptureScreenImage()
    {
        return CaptureWindowBitmap(User32.GetDesktopWindow()).ToImage<Bgr, byte>();
    }
    ...
    public Bitmap CaptureWindowBitmap(IntPtr handle)
    {
        // get te hDC of the target window
        IntPtr hdcSrc = User32.GetWindowDC(handle);
        // get the size
